...
[Gateway](https://github.com/rpcx-ecosystem/rpcx-gateway) is a http gateway for rpcx services.

You can write rpc http clients in any programming languages such as Java、Python、C#、Node.js、Php、C\C++、Rust and others. See [examples](https://github.com/rpcx-ecosystem/rpcx-gateway/blob/master/examples/README.md) for many languages.
